...
```json
{
  "teambit.generator/generator": {
    "envs": [
      "ignacioaldama.ci-test/envs/my-react-env"
    ]
  }
}
```
...
```
bit env set my-component ignacioaldama.ci-test/envs/my-react-env
```
...
```
bit new react my-workspace --aspect ignacioaldama.ci-test/envs/my-react-env
```
